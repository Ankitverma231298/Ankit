...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Ashish Codespeedy project")
        ...
        #Title of App
        title = Label(self.root,text = "Ankit Billing Software",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
        ...
        #===========
        bill_title = Label(F3,text = "Ankit Bill Area",font = ("Lucida",13,"bold"),bd= 7,relief = GROOVE)
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Welcome To Ashish Retail\n")
